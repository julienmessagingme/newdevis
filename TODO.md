...
- [ ] 🔴 **2bis-C. LES 4 POSTES ACCUSÉS À TORT — la liste de travail actuelle** : *Parquet stratifié* 1 589 € · *Pose faïence murale* 303 € · *Isolation plancher polystyrène* 42 € · *Pose panneaux OSB* 11 €, tous sur *Devis 25030*. ⚠️ Les rapprochements sont JUSTES (l'entrée catalogue décrit bien l'ouvrage) — ce sont donc des **fourchettes à instruire**, pas du moteur. Le devis 25030 dit même son prix matière sur la faïence (« 40 € HT/m² »).
