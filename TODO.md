...
- [ ] 🟡 **« OFFRES COMMERCIALES DE NOS PARTENAIRES SÉLECTIONNÉS » — AUCUN PARTENAIRE N'EXISTE (2026-09-13)** — la case à cocher du formulaire d'inscription propose de recevoir « des offres commerciales de nos **partenaires sélectionnés** », alors qu'aucun partenariat n'est en place et qu'**aucun lead n'est transmis à un tiers** (règle du 27/08, réaffirmée par le sondage du 13/09 qui a justement banni tout mot d'offre). La case est cohérente avec une intention future, pas avec la réalité d'aujourd'hui — et elle dit exactement ce que l'utilisateur redoute au moment où il hésite à s'inscrire. ⚠️ Décision produit : la retirer, ou la reformuler sur ce qu'on fait vraiment (nos propres communications). Ne pas la modifier sans trancher l'intention commerciale derrière.
