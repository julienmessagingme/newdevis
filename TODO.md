...
- [ ] 🟢 **CHERCHER LA PERSONNE QUAND LE NOM COMMERCIAL NE DONNE RIEN (2026-09-13)** — la vraie piste, trouvée en réfutant la précédente. « Entreprise FK » ne désigne aucune entreprise ; `q=Forgeas Kurtis` (le nom porté par l'adresse e-mail de l'en-tête) rend **un seul résultat** : *KURTIS FORGEAS, SIREN 809 748 759, APE 43.91B travaux de couverture, active* — métier exactement cohérent avec le devis, et le numéro imprimé est ce SIREN avec trois chiffres mal lus (6→9, 1→4, 3→8). **Un nom commercial n'est pas une raison sociale**, et chez les artisans en entreprise individuelle la raison sociale est simplement le nom de la personne. ⚠️ **Préalable** : ni l'e-mail ni le nom du contact ne sont extraits aujourd'hui (`extracted.entreprise` n'a que nom / siret / adresse / iban / assurances / certifications). Il faut donc (1) les extraire, (2) ajouter un 4ᵉ repli « par personne » après le repli par nom, (3) le mesurer sur les 17 cas du banc — c'est le harnais qui existe déjà.
