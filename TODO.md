...
- [ ] 🟡 **L114 — UNE RÉPONSE DE L'ÉTALON À CONFIRMER (2026-09-11)** : « Scellement de tuile à l'égout bas de pente », 26,4 **ml** pour 396 € (15 €/ml). Johan a répondu « 1 » = *Couverture tuile béton (fourni+posé)*, un tarif de **toiture entière au m²** (70-140 €/m²) — l'unité ne colle pas et le périmètre non plus. La réponse n'a **pas** été enregistrée en attendant confirmation : une bonne réponse fausse dans l'étalon fausse toutes les mesures suivantes, et la règle du projet dit de ne pas traiter les réponses humaines comme un oracle. Si c'est bien « aucune », la ligne désigne une famille manquante — **scellement de rive / d'égout au ml** — déjà listée plus bas comme à sourcer.

- [ ] 🟡 **CATALOGUE — CE QUI RESTE APRÈS LA PASSE DU 2026-09-11** : trois familles écartées volontairement, à rouvrir si elles se répètent. **Coffret de communication VDI** (2 lignes) — le prix de pose n'est pas sourçable et « Coffret GTL » (150-480 €) couvre un périmètre très proche, risque de doublon. **Planelle de coffrage / about de plancher** (1 ligne, 809 €) — une occurrence ne fait pas une famille. **Scellement de rive / d'égout au ml** (L069, L114 : 1 369 €) — le catalogue a « Remplacement faîtage + solin » mais rien pour le scellement d'égout ou de rive seul ; à sourcer. ⚠️ Et trois des six fourchettes livrées sont signalées comme les moins sûres dans la migration (`sortie_cable`, `tuile_chatiere_douille`, `enduit_dressage_chaux`) : `last_reviewed_at` est NULL, elles attendent Julien.
