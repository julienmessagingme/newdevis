...
- 🟡 **3 conclusions du stock affichent encore DEUX montants pour un seul écart** — `Devis 1- DC0424` (640 ≠ 420), `DEV-05675` (519 ≠ 552), `Devis - DE2090` (2 024 ≠ 2 223). Le correctif du 22/09 vit dans `leviersBuilder`, donc il ne vaut que pour les analyses à venir ; `verdict_ligne.motif` est figé dans `conclusion_ia`. Réparable à la main comme les marges du 11/09 (script de chirurgie minimale, garde `corrected`), ou par régénération ciblée — décision à prendre.
- 🔴 **LA FOURCHETTE DEMANDÉE PAR JOHAN (22/09) N'EST PAS RÉALISABLE TELLE QUELLE — à trancher.** *« il vaut mieux toujours donner une fourchette pour être prudent (dans cet exemple entre 1 800 € et 2 300 €) »*. Une fourchette **autour** du chiffre est décorative, donc interdite depuis le 15/09 (« un intervalle décoratif est un chiffre faux » — c'est exactement le ×1,3 supprimé ce jour-là). Une fourchette **calculée** est possible et la règle du 15/09 en donne la méthode : écart au **plafond** du marché face à l'écart au **plancher**. ⚠️ Mais elle va dans l'autre sens — elle DURCIT : sur Vilette, 3 880 € (plafond) contre 5 416 € (plancher). Annoncer « 2 223 à 4 100 € » est plus accusateur, pas plus prudent. **Trois options à arbitrer** : (a) garder le chiffre unique, (b) fourchette calculée qui durcit, (c) arrondir (« environ 2 200 € ») — ⚠️ mais l'arrondi décroche le montant de la somme des postes nommés, ce que le 15/09 interdit aussi.
