...
- [ ] 🔴 **2bis-A. LES 8 POSTES RÉELLEMENT RÉACCUSÉS — le seul compteur d'anti-régression qui tienne** : **4 devis · 8 postes · 6 857 €**, tous vérifiés un par un contre les anomalies annulées (zéro faux positif). Deux causes, nommées par l'expert lui-même :
  ...
  - ⚠️ **NE PAS EN TIRER UN SEUIL DE RATIO SANS MESURE** — huit postes ne sont pas une population, et ce projet a déjà refusé deux règles validées sur des sous-groupes de cette taille (seuil de marge, catégorie d'extraction, les 11/09). **Le rejeu du stock est le seul juge.** Trois seuils candidats à mesurer AVANT toute livraison : plancher absolu par poste · plancher relatif au plafond (ratio) · poids du poste dans le devis.

- [ ] 🟡 **2bis-B. LES 7 DEVIS « JAMAIS JUGÉS » — à instruire, pas à corriger** : 24 postes, 19 226 €, dont *25030* (9 078 € sur 11 postes) et *Devis-travaux* (3 720 € sur 2). L'étalon ne peut rien en dire : personne ne les a jugés. Les soumettre à une revue humaine les ferait entrer dans le gold standard — c'est le geste qui grandit l'étalon au lieu d'en inventer les réponses.
