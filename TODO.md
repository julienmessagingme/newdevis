...
- [ ] 🟡 **RE-SOUMETTRE SIX LIGNES DE L'ÉTALON (2026-09-11)** — les 6 entrées ajoutées comblent **L028, L097, L109, L114, L150, L152**, que l'étalon classe encore « aucune entrée valable » : c'était vrai de leurs cinq candidats d'alors, faux depuis. Une question chacune. Sans ça le score continue de compter ces lignes comme des trous et **sous-estime durablement le catalogue** — exactement ce qui s'était produit le 10/09. ⚠️ Réflexe à garder : tout ajout au catalogue périme l'étalon sur les lignes qu'il comble.
