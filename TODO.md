...
- 🟡 **Le bouton « Copier » du message n'a jamais été exercé** — il vit dans le dépli, donc ni l'aperçu statique ni le rendu interactif ne l'atteignent, et le projet n'a pas de testing-library. Il déclenche `openFeedback("manual_copy")`, un des deux seuls déclencheurs de la modale de retour : à vérifier dans le navigateur, ou à couvrir en ajoutant `@testing-library/react`.
