/**
 * supabase/functions/analyze-quote/reconciliation.ts
 *
 * 🟢 Phase 3.1 (2026-06-24) — Module de réconciliation arithmétique (DENO COPY)
 *
 * COPIE IDENTIQUE de src/lib/analyse/extract/reconciliation.ts (Node/Vite version).
 * Source de vérité = la version Node, testée par Vitest (23/23 tests passants).
 * Synchroniser à la main tant qu'on n'a pas mis en place un package partagé.
 * Diff au moindre changement avant commit.
 *
