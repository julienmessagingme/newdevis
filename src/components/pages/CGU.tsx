        ...
        <div className="container max-w-3xl">
          ...
          <div className="space-y-8">
            ...
            <section className="bg-card border border-border rounded-xl p-6">
              ...
              <p className="text-muted-foreground">
                Tout professionnel estimant qu'une information est inexacte peut demander une rectification via le <a href="/contact" className="text-primary hover:underline">formulaire de contact</a>.
              </p>
            </section>
          </div>
