...
const REVIEWS = [
  ...
  },
  {
    ...
    body: "Très bon outil, j'ai utilisé le site avant de signer un devis pour une rénovation de salle de bain. L'analyse m'a donné confiance et j'ai évité une mauvaise surprise.",
    date: 'mars 2026',
    stars: 5,
  },
  {
    ...
    author: 'Thomas B.',
    initials: 'TB',
    title: 'Pratique et fiable',
    body: "Service pratique qui permet de vérifier rapidement si un devis est cohérent avec le marché. L'outil m'a aidé à comparer plusieurs artisans.",
    date: 'mars 2026',
    stars: 5,
  },
  {
    ...
    author: 'Nathalie G.',
    initials: 'NG',
    title: 'Un vrai plus avant de signer',
    body: "Excellent service, gratuit et efficace. En quelques minutes j'ai su si mon devis de peinture était dans les clous. Je conseille à toute personne qui engage des travaux.",
    date: 'mars 2026',
    stars: 5,
  },
];
