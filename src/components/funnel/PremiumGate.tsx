  ...
  return (
    <div className="border border-primary/20 rounded-xl overflow-hidden">
      ...
      >
        ...
        <span className="text-sm font-semibold text-primary flex-1 text-left">{title}</span>
        <ChevronDown className={`h-4 w-4 text-primary transition-transform duration-200 ${isExpanded ? 'rotate-180' : ''}`} />
      </button>
      ...
      {isExpanded && (
        <div className="p-4 sm:p-6 border-t border-primary/10">
          <p className="text-sm text-muted-foreground text-center mb-3">
            Créez votre compte gratuit pour accéder à l'analyse complète
          </p>
