...
import { optionsResponse, jsonOk, jsonError, requireAuth, parseJsonBody, hasGmcWriteAccess, gmcPaywallResponse } from '@/lib/api/apiHelpers';
...
export const POST: APIRoute = async ({ request }) => {
  ...
  // Lecture seule : essai expiré / non payé → pas de modification IA.
