...
- **La couverture est partielle : 31 % du montant d'un devis en médiane** (mesuré le 2026-08-30 sur 100 devis français, 1,79 M€ — les devis en francs CFA, qui pèsent des millions, sont écartés sinon ils écrasent l'agrégat). Ce n'est pas un défaut caché : les prestations sans référence sont nommées par leur nature et leur montant, jamais par un pourcentage (cf. CLAUDE.md).
