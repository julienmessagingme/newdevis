...
- **La couverture est partielle : 41 % du montant d'un devis en médiane** sur les analyses postérieures à l'enrichissement du catalogue du 2026-08-27 (30 % sur les analyses antérieures — la médiane globale de 31 % mesurée le 30/08 portait donc surtout sur un stock périmé, piège à ne pas refaire). Devis en francs CFA écartés de la mesure : leurs montants en millions écrasent l'agrégat. Ce n'est pas un défaut caché : les prestations sans référence sont nommées par leur nature et leur montant, jamais par un pourcentage (cf. CLAUDE.md).

  **⚠️ Et ce n'est PAS un manque d'entrées au catalogue.** Décomposition du montant : 38 % rapproché avec confiance haute, **46 % en confiance moyenne** (rapproché, mais sous la barre), 2 % faible, **13 % seulement sans aucun rapprochement** — dont une bonne part n'est comparable par nature (une ligne « Dommage Ouvrage », un enlèvement de gravats, du bruit d'extraction type « 17250 euro »). Le plafond est donc la **qualité du rapprochement**, pas la taille du catalogue.

  **Pourquoi on ne baisse pas le seuil de confiance.** Descendre HIGH de 0,77 à 0,75 ferait passer la couverture de 40 % à 60 % du montant — mécaniquement. Mais l'inspection de la bande 0,75–0,77 (389 groupes, 365 k€) montre qu'**environ la moitié des rapprochements y sont faux** : « ossature bois 60×180 » → *clôture bois occultante* (13 621 €), bardage industriel double peau → *bardage HPL haut de gamme*, « Plomberie suivant plan » à 9 182 € → *plomberie petite intervention*, réfection électrique complète → *tableau électrique neuf*. Gagner de la couverture à ce prix, c'est réintroduire les faux surcoûts qu'on passe notre temps à retirer. **La couverture n'est pas un objectif en soi : une comparaison fausse vaut moins que pas de comparaison.**

  **Le vrai levier identifié** : notre catalogue est **plus granulaire que la façon dont les artisans rédigent**. Beaucoup de lignes sont des forfaits composites (« Plomberie, sanitaire suivant plan », « Réfection totale du système électrique ») que nous rapprochons d'entrées unitaires, d'où une similarité moyenne et un ordre de grandeur incompatible. Piste à instruire : des entrées **composites** au bon niveau (installation électrique complète d'un logement, lot plomberie complet, bardage industriel, ossature bois), qui feraient monter la similarité *et* donneraient une fourchette défendable. Suivi dans `TODO.md`.
